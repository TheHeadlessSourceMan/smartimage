...
def toneSplit(image,atPoints=None,absolute=False):
	"""
...
def tritoneTint(image,tintColors,tintAmounts=1.0,atPoints=None,absolute=False):
	"""
	...
	for i,tone in enumerate(tones):
		tones[i]=tint(tone,tintColors[i],tintAmounts[i])
